...
\hline
\textbf{Proposed CQC-Net (CI-GCI)} & \textbf{0.9485} & \textbf{0.8120} & \textbf{0.8350} & \textbf{0.8150} & \textbf{0.6920} & \textbf{0.6780} & \textbf{0.4120} & \textbf{0.6150} & \textbf{0.8620} & \textbf{0.1080} & \textbf{0.8520} & \textbf{0.9380} & \textbf{0.0215} \\
\hline
\end{tabular}%
}
\end{table*}
