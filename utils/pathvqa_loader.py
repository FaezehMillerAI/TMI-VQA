    ...
    def __init__(self, data_dir="data/pathvqa", split="train", img_size=(224, 224)):
        ...
        if parquet_files and HAS_PARQUET:
            ...
            raise FileNotFoundError(
                f"[PathVQA] No parquet files found matching '{pattern}' in '{self.data_dir}'.\n"
                "Please download the PathVQA dataset (e.g., via 'python run_kaggle_pipeline.py' or Hugging Face 'flaviagiammarino/path-vqa')."
            )
