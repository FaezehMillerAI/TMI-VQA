    ...
    def __init__(self, data_dir="data/kvasir", split="train", img_size=(224, 224)):
        ...
        if parquet_files and HAS_PARQUET:
            ...
            raise FileNotFoundError(
                f"[Kvasir-VQA] No parquet files found matching '{pattern}' in '{self.data_dir}'.\n"
                "Please download the Kvasir-VQA dataset (e.g., via 'python run_kaggle_pipeline.py' or Hugging Face 'SimulaMet/Kvasir-VQA-x1')."
            )
