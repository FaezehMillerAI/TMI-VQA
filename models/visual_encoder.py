    ...
    def __init__(self, backbone_type: str = "vit", visual_dim: int = 768):
        ...
        if self.backbone_type == "resnet":
            ...
            try:
                ...
                print(f"Failed to load ViT model: {e}. Falling back to lightweight convolutional backbone.")
            ...
            try:
                ...
                print(f"Failed to load BiomedCLIP Vision model: {e}. Falling back to lightweight convolutional backbone.")
                self.backbone = nn.Sequential(
                    nn.Conv2d(3, 64, kernel_size=7, stride=2, padding=3),
                    nn.ReLU(),
                    nn.MaxPool2d(kernel_size=3, stride=2, padding=1),
